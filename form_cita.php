<?php
    ...
    $medico     = new medico();
    $mostrar_paciente   = $paciente->select_paciente();
    $mostrar_medico     = $medico->select_medico();
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Recepcionista | Nueva cita</title>
...
<body>
    ...
    <header>
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li><a class="dropdown-item" href="show_paciente.php">Mostrar lista pacientes</a></li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item active" href="form_cita.php">Nueva cita medica</a></li>
                                <li>
                                    <hr class="dropdown-divider">
                                </li>
        ...
        <div class="cover d-flex justify-content-end align-items-start p-5 flex-column" style="background-image: url(resource/img/img-6.jpg);">
            ...
            <p>La inversión a nuestros pacientes es la mejor.</p>
            <form action="search_paciente.php">
            ...
            <div class="col-12 col-md-10 col-lg-10 px-5 pt-5 pb-3" style="background-color: #D6DBDF;">
                ...
                <form action="" id="form">
                    <div class="row g-3">
                        ...
                        <input type="text" name="Recepcionista_ID" value="<?php echo $_SESSION['id']; ?>" hidden>
                        <!-- Nombre del paciente -->
                        <div class="col-sm-5">
                            <label for="NombreP" class="form-label">Paciente</label>
                            <select class="form-select" id="NombreP" name="NombreP">
                                <option value="" class="text-center form-text" selected>Elige una opción</option>
                                <?php
                                    foreach ($mostrar_paciente as $row) {
                                        $Paciente_ID = $row['ID'];
                                ?>
                                        <option value="<?php echo $Paciente_ID; ?>" ><?php echo $row['Nombre'].' '.$row['Apellidos']; ?></option>
                                <?php
                                    }
                                ?>
                            </select>
                            ...
                            <select class="form-select" id="Hora" name="Hora">
                                <?php
                                    foreach ($horas as $row) {
                                        if ($row < "12:00") {
                                ?>
                                        <option value="<?php echo $row; ?>" ><?php echo $row.' a.m.'; ?></option>
                                <?php
                                        } else {
                                ?>
                                        <option value="<?php echo $row; ?>" ><?php echo $row.' p.m.'; ?></option>
                                <?php
                                        }
                                    }
                                ?>
                        ...
                        <!-- Nombre del médico -->
                        <div class="col-sm-8">
                            <label for="NombreM" class="form-label">Médico - Especialidad</label>
                            <select class="form-select" id="NombreM" name="NombreM">
                                <option value="" class="text-center form-text" selected>Elige una opción</option>
                                <?php
                                    foreach ($mostrar_medico as $row) {
                                        $Medico_ID = $row['ID'];
                                ?>
                                        <option value="<?php echo $Medico_ID; ?>" ><?php echo $row['Nombre'].' '.$row['Apellidos'].' - '.$row['Especialidad']; ?></option>
                                <?php
                                    }
                                ?>
                            </select>
    ...
    <script src="js/funCita.js"></script>
