<?php
    ...
    $cita = new cita();
    $mostrar_datos = $cita->select_cita();
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Recepcionista | Mostrar citas</title>
...
<body>
    ...
    <header>
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li><a class="dropdown-item active" href="show_cita.php">Mostrar lista citas</a></li>
                            </ul>
                        </li>
                        <li class="nav-item">
        ...
        <div class="cover d-flex justify-content-end align-items-start p-5 flex-column" style="background-image: url(resource/img/img-12.jpg);">
            <h1>Mostrar citas</h1>
            <p>La mejor accesibilidad en horarios.</p>
            <form action="form_cita.php">
        ...
        <div class="container mt-5 mb-5">
                    ...
                    <tbody id="tabla-cita">
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php echo $row['Nombre_paciente'].' '.$row['Apellidos_paciente'];?></td>
                                <td><?php echo $row['Nombre_medico'].' '.$row['Apellidos_medico']; ?></td>
            ...
            ?>
                <div class="alert alert-primary d-flex align-items-center" role="alert">
                    ...
                    <div>
                    No se encuentran citas registradas en la base de datos.
                    </div>
                </div>
            <?php
             }
    ...
    <script src="js/funCita2.js"></script>
