...
<body>
    ...
    <header>
                    ...
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item active" href="form_recepcionista.php">Nuevo recepcionista</a></li>
                                <li>
        ...
        <div class="cover d-flex justify-content-end align-items-start p-5 flex-column" style="background-image: url(resource/img/img-7.jpg);">
            <h1>Agregar recepcionista</h1>
            <p>El mejor atención medica.</p>
            <form action="search_recepcionista.php">
    ...
    <script src="js/funRecepcionista.js"></script>
